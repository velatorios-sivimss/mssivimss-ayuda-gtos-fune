...
@XmlType(name = "AGF_Asegurado", propOrder = {
    "cadena",
    "transaccion",
    "tipoProceso",
    "nss",
...
public class AGFAsegurado {
    ...
    @XmlElement(required = true)
    protected AGFAseguradoFinado datosFinado;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link AGFAseguradoFinado }
     *     
     */
    public AGFAseguradoFinado getDatosFinado() {
        return datosFinado;
    }
     ...
     *     
     */
    public void setDatosFinado(AGFAseguradoFinado value) {

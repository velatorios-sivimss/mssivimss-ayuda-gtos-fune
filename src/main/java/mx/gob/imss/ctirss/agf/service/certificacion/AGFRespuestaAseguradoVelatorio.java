...
/**
 * <p>Clase Java para AGF_Respuesta_Asegurado_Velatorio complex type.
 * 
...
@XmlType(name = "AGF_Respuesta_Asegurado_Velatorio", propOrder = {
    "nombreVelatorio",
    "numeroVelatorio",
...
public class AGFRespuestaAseguradoVelatorio {
    ...
    @XmlElement(required = true)
    protected BigInteger cuentaClabe;
    @XmlElement(required = true)
     ...
     *     
     */
    public BigInteger getCuentaClabe() {
        return cuentaClabe;
    }
     ...
     *     
     */
    public void setCuentaClabe(BigInteger value) {

...
/**
 * <p>Clase Java para AGF_Respuesta_Asegurado_Finado complex type.
 * 
...
@XmlType(name = "AGF_Respuesta_Asegurado_Finado", propOrder = {
    "nombre",
    "apPaterno",
    "apMaterno",
    "curp",
...
public class AGFRespuestaAseguradoFinado {

/**
 * AGF_Respuesta_Asegurado_Velatorio.java
 *
...
public class AGF_Respuesta_Asegurado_Velatorio  implements java.io.Serializable {
    ...
    private java.math.BigInteger cuentaClabe;

    private java.lang.String estatusClabe;

    public AGF_Respuesta_Asegurado_Velatorio() {
    }
    ...
    public AGF_Respuesta_Asegurado_Velatorio(
           ...
           java.math.BigInteger cuentaClabe,
    ...
    /**
     * Gets the nombreVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Sets the nombreVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Gets the numeroVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Sets the numeroVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Gets the responsableVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Sets the responsableVelatorio value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
    ...
    /**
     * Gets the banco value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @return banco
     */
    ...
    /**
     * Sets the banco value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @param banco
     */
    ...
    /**
     * Gets the cuentaClabe value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @return cuentaClabe
     */
    public java.math.BigInteger getCuentaClabe() {
        return cuentaClabe;
    }


    /**
     * Sets the cuentaClabe value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @param cuentaClabe
     */
    public void setCuentaClabe(java.math.BigInteger cuentaClabe) {
        this.cuentaClabe = cuentaClabe;
    }


    /**
     * Gets the estatusClabe value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @return estatusClabe
     */
    ...
    /**
     * Sets the estatusClabe value for this AGF_Respuesta_Asegurado_Velatorio.
     * 
     * @param estatusClabe
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AGF_Respuesta_Asegurado_Velatorio)) return false;
        AGF_Respuesta_Asegurado_Velatorio other = (AGF_Respuesta_Asegurado_Velatorio) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AGF_Respuesta_Asegurado_Velatorio.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://certificacion.service.agf.ctirss.imss.gob.mx/", "AGF_Respuesta_Asegurado_Velatorio"));
